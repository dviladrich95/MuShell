...
if __name__ == '__main__':
    ...
    qimg_output_file = os.path.join(os.getcwd(),'boxes.png')
    cv.imwrite(qimg_output_file, img_boxes)
    ...
    cv.waitKey(0)
    qimg_output_file = os.path.join(os.getcwd(),'quantized_boxes.png')
    cv.imwrite(qimg_output_file, img_qboxes)
